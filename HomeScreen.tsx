      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.aboutSection}>
          ...
          <Text style={styles.aboutText}>
            ...
            Thousands of domestic workers and gardeners have been trained with the successful long 
            term courses and Short Skills Training Programmes to empower themselves and can provide 
            more marketable skills.
          </Text>
          <Text style={styles.imagePlaceholder}>Team Image Placeholder</Text>
        </View>
        ...
        <View style={styles.navigation}>
          <TouchableHighlight 
            ...
            underlayColor="#666"
          >
            <Text style={styles.buttonText}>Short Term Courses</Text>
          </TouchableHighlight>
          ...
          <TouchableHighlight 
            ...
            underlayColor="#666"
          >
            <Text style={styles.buttonText}>Long Term Courses</Text>
          </TouchableHighlight>
          ...
          <TouchableHighlight 
            style={styles.navButton}
            onPress={() => alert('Contact form coming soon')}
            underlayColor="#666"
          >
